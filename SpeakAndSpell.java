...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		speak("spell torbeldnam");
		String ans2 = JOptionPane.showInputDialog("what is your answer?");
		if (ans.equals("torbeldnam")) {
